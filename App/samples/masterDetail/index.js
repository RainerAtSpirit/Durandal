define(["require", "exports", 'durandal/viewModel', './project'], function(require, exports, __viewModel__, ___Project__) {
    var viewModel = __viewModel__;

    var _Project = ___Project__;

    var Project = _Project.ctor;
    Project.prototype['__moduleId__'] = _Project['__moduleId__'];
    exports.projects = ko.observableArray([
    ...
    exports.activeProject = viewModel.activator().forItems(exports.projects);
})
